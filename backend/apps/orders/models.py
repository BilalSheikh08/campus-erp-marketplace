    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="orders_cartitem_cart_id_20a341_idx",
            ),
            models.Index(
                fields=["listing"],
                name="orders_cartitem_listing_6dbd50_idx",
            ),
        ]
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="orders_order_user_id_6c1c55_idx",
            ),
            models.Index(
                fields=["status", "created_at"],
                name="orders_order_status_5d8ca5_idx",
            ),
            models.Index(
                fields=["payment_status", "created_at"],
                name="orders_order_payment_0f3c14_idx",
            ),
        ]
        constraints = [
            models.CheckConstraint(
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="orders_orderstatuslog_order_id_6c3f3d_idx",
            ),
        ]

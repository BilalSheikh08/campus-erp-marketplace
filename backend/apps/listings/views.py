...
class ListingDetailView(ListingQuerysetMixin, generics.RetrieveUpdateDestroyAPIView):
    ...
    def perform_update(self, serializer):
        ...
        if instance.category_type == Listing.Category.BOOK and instance.status == Listing.Status.SOLD:
            raise ValidationError({"detail": "Sold books cannot be edited. Create a new listing instead."})
        serializer.save()
